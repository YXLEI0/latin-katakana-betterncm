  ...
  function createLearned(opts) {
    ...
    function note(word, kana, line, localKana) {
      ...
      if (rec) {
         ...
         * 人名地名…）。那就**撤掉**离线条目：留着只会一直读错，而且模型没机会纠。
         */
        delete words[w];
        delete seen[w];
        schedule();
