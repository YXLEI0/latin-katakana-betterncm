...
- 另有 [sljfaq](https://www.sljfaq.org/afaq/gairaigo.html) 的德语 / 荷兰语 / 葡萄牙语 / 俄语 / 法语借词表 (`tools/vendor/loan/`, `npm run build:loan`), 记的是**日语通行写法** (`Lied` リート, `bier` ビール, `pao` パン, `норма` ノルマ), 只在该语言的行上生效 —— `rose` 在法语行是 ロゼ、英文行仍是 ローズ
